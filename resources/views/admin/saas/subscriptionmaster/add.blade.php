            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add Subscription Package</h5>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="package_description" class="form-control" id="package_description"
                                        placeholder="Brief description">{{ old('package_description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" name="package_price" class="form-control" id="package_price"
                                        placeholder="0.00" value="{{ old('package_price') }}" step="0.01">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" name="package_duration_days" class="form-control" id="package_duration_days"
                                        placeholder="Number of days" value="{{ old('package_duration_days') }}">
                                </div>
                            </div>
