...
@section('page-title', 'Confirm Delete Kota')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Are you sure want to delete this Kota?</h3>
                </div>
            ...
            <div class="m-4">
                ...
                <form action="{{ route('admin.master-kota.delete', $data->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    <th scope="col" class="bg-dark text-white">Kode Kota</th>
                                    <td>{{ $data->kode_kota }}</td>
                                </tr>
                                <tr>
                                    <th scope="col" class="bg-dark text-white">Nama Kota</th>
