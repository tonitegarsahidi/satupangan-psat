...
@section('page-title', 'Edit Pengawasan Tindakan Lanjutan')
...
@section('main-content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <!-- Edit Pengawasan Tindakan Lanjutan Form -->
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit Pengawasan Tindakan Lanjutan</h5>
                        <small class="text-muted float-end">* : must be filled</small>
                    </div>
                    @include('admin.components.notification.error')
                    <div class="card-body">
                        <form action="{{ route('pengawasan-tindakan-lanjutan.update', $pengawasanTindakanLanjutan->id) }}"  method="POST">
                            @method('PUT')
                            @csrf
                                    ...
                                    <select name="pengawasan_tindakan_id" class="form-select" id="pengawasan_tindakan_id" required>
                                        ...
                                        @foreach ($pengawasanTindakans as $tindakan)
                                            <option value="{{ $tindakan['id'] }}"
                                                ...
                                                {{ old('pengawasan_tindakan_id', isset($pengawasanTindakanLanjutan->pengawasan_tindakan_id) ? $pengawasanTindakanLanjutan->pengawasan_tindakan_id : '') == $tindakan['id'] ? 'selected' : '' }}>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <p id="selected-tindak-lanjut" class="mb-1">...</p>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <strong>PIC Tindakan:</strong>
                                                    <p id="selected-pimpinan" class="mb-1">...</p>
                                                </div>
                                                <div class="col-md-3">
                                                    <strong>Rekap Pengawasan:</strong>
                                                    <p id="selected-rekap-judul" class="mb-1">...</p>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-md-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="user_id_pic" class="form-select" id="user_id_pic" required>
                                        ...
                                        @foreach ($pics as $pic)
                                            <option value="{{ $pic->id }}"
                                                {{ old('user_id_pic', isset($pengawasanTindakanLanjutan->user_id_pic) ? $pengawasanTindakanLanjutan->user_id_pic : '') == $pic->id ? 'selected' : '' }}>
                                                {{ $pic->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="status" class="form-select" id="status" required>
                                        ...
                                        @foreach (\App\Models\PengawasanTindakanLanjutan::getStatusOptions() as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old('status', isset($pengawasanTindakanLanjutan->status) ? $pengawasanTindakanLanjutan->status : '') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_active" id="is_active_true" value="1"
                                            {{ old('is_active', isset($pengawasanTindakanLanjutan->is_active) ? $pengawasanTindakanLanjutan->is_active : '') == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_active" id="is_active_false" value="0"
                                            {{ old('is_active', isset($pengawasanTindakanLanjutan->is_active) ? $pengawasanTindakanLanjutan->is_active : '') == 0 ? 'checked' : '' }}>
