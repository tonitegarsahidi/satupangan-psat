                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('business.update', $business->id) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="nama_perusahaan" class="form-control" id="nama_perusahaan"
                                        placeholder="contoh: PT. Contoh Jaya" value="{{ old('nama_perusahaan', $business->nama_perusahaan) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="alamat_perusahaan" class="form-control" id="alamat_perusahaan" rows="3"
                                        placeholder="contoh: Jl. Contoh No. 1" required>{{ old('alamat_perusahaan', $business->alamat_perusahaan) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="jabatan_perusahaan" class="form-control" id="jabatan_perusahaan"
                                        placeholder="contoh: Direktur" value="{{ old('jabatan_perusahaan', $business->jabatan_perusahaan) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="nib" class="form-control" id="nib"
                                        placeholder="contoh: 1234567890" value="{{ old('nib', $business->nib) }}" required>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_umkm" id="is_umkm" value="1"
                                            {{ old('is_umkm', $business->is_umkm) ? 'checked' : '' }}>
                            ...
                            @include('components.provinsi-kota', [
                                'provinsis' => $provinsis,
                                'kotas' => $kotas ?? [],
                                'selectedProvinsiId' => old('provinsi_id', $business->provinsi_id),
                                'selectedKotaId' => old('kota_id', $business->kota_id),
