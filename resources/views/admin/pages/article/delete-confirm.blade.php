...
@section('page-title', 'Confirm Delete Article')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Are you sure want to delete this Article?</h3>
                </div>
            ...
            <div class="m-4">
                ...
                <form action="{{ route('admin.article.destroy', $data->id) }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-danger me-2" href="{{ route('admin.article.edit', ['id' => $data->id]) }}"
