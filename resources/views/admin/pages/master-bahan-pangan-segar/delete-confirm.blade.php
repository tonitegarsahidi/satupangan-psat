...
@section('page-title', 'Confirm Delete Bahan Pangan Segar')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Are you sure want to delete this Bahan Pangan Segar?</h3>
                </div>
            ...
            <div class="m-4">
                ...
                <form action="{{ route('admin.master-bahan-pangan-segar.delete', $data->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    <th scope="col" class="bg-dark text-white">Jenis Pangan Segar</th>
                                    <td>{{ $data->jenis->nama_jenis_pangan_segar }}</td>
                                </tr>
                                <tr>
                                    <th scope="col" class="bg-dark text-white">Kode Bahan Pangan Segar</th>
