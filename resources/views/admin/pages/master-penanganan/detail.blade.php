...
@section('page-title', 'Detail of Master Penanganan')
        ...
        <div class="card">
            <div class="d-flex justify-content-between">
                <div class="bd-highlight">
                    <h3 class="card-header">Detail of Master Penanganan with id : {{ $data->id }}</h3>
                </div>
            </div>
            ...
            <div class="m-4">
                ...
                <a class="btn btn-primary me-2" href="{{ route('admin.master-penanganan.edit', ['id' => $data->id]) }}"
                    title="update this penanganan">
                    <i class='tf-icons bx bx-pencil me-2'></i>Edit</a>
                <a class="btn btn-danger me-2" href="{{ route('admin.master-penanganan.delete', ['id' => $data->id]) }}"
