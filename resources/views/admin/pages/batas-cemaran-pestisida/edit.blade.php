            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.batas-cemaran-pestisida.update', $batasCemaranPestisida->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                @php
                                    $oldIsActive = old('is_active', $batasCemaranPestisida->is_active); // Default to current value
                                @endphp
