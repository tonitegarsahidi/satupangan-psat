                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="cemaran_pestisida" id="cemaran_pestisida" class="form-select" required>
                                        ...
                                        @foreach ($cemaranPestisidas as $cemaranPestisida)
                                            <option value="{{ $cemaranPestisida->id }}">{{ $cemaranPestisida->nama_cemaran_pestisida }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="metode" class="form-control" id="metode"
                                        placeholder="contoh: GC-MS" value="{{ old('metode') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="keterangan" class="form-control" id="keterangan" rows="3"
                                        placeholder="contoh: Batas maksimum untuk pestisida dalam pangan">{{ old('keterangan') }}</textarea>
                                </div>
                            </div>
