...
@section('page-title', 'Detail of Batas Cemaran Pestisida')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Detail of Batas Cemaran Pestisida with id : {{ $data->id }}</h3>
                </div>
            ...
            <div class="m-4">
                ...
                <a class="btn btn-primary me-2" href="{{ route('admin.batas-cemaran-pestisida.edit', ['id' => $data->id]) }}"
                    title="update this batas cemaran pestisida">
                    <i class='tf-icons bx bx-pencil me-2'></i>Edit</a>
                <a class="btn btn-danger me-2" href="{{ route('admin.batas-cemaran-pestisida.delete', ['id' => $data->id]) }}"
