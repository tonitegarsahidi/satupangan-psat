...
@section('page-title', 'Confirm Delete Register SPPB')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Are you sure want to delete this Register SPPB?</h3>
                </div>
            ...
            <div class="m-4">
                ...
                <form action="{{ route('register-sppb.delete', $data->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
