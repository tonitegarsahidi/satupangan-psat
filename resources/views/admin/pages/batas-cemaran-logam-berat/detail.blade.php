...
@section('page-title', 'Detail Batas Cemaran Logam Berat')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Detail Batas Cemaran Logam Berat</h5>
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.batas-cemaran-logam-berat.edit', $data->id) }}" class="btn btn-warning">
                                <i class="bx bx-edit me-1"></i> Edit
                            </a>
                            <a href="{{ route('admin.batas-cemaran-logam-berat.index') }}" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Cemaran Logam Berat</label>
                                    <p class="form-control-plaintext">{{ $data->cemaranLogamBerat->nama_cemaran_logam_berat ?? '-' }}</p>
                                </div>
