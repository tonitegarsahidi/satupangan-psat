...
@section('page-title', 'Add New Batas Cemaran Logam Berat')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add Batas Cemaran Logam Berat</h5>
                        <small class="text-muted float-end">* : must be filled</small>
                    </div>
                    <div class="card-body">

                        <form method="POST" action="{{ route('admin.batas-cemaran-logam-berat.store') }}">
                            @csrf
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="cemaran_logam_berat" id="cemaran_logam_berat" class="form-select" required>
                                        ...
                                        @foreach ($cemaranLogamBerats as $cemaranLogamBerat)
                                            <option value="{{ $cemaranLogamBerat->id }}">{{ $cemaranLogamBerat->nama_cemaran_logam_berat }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="satuan" class="form-control" id="satuan"
                                        placeholder="contoh: mg/kg" value="{{ old('satuan') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="metode" class="form-control" id="metode"
                                        placeholder="contoh: AAS" value="{{ old('metode') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="keterangan" class="form-control" id="keterangan" rows="3"
                                        placeholder="contoh: Batas maksimum untuk logam berat dalam pangan">{{ old('keterangan') }}</textarea>
                                </div>
                            </div>
