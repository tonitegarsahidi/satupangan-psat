...
@section('page-title', 'Confirm Delete Batas Cemaran Logam Berat')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Are you sure want to delete this Batas Cemaran Logam Berat?</h3>
                </div>
            ...
            <div class="m-4">
                ...
                <form action="{{ route('admin.batas-cemaran-logam-berat.delete', $data->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
