...
@section('page-title', 'Add New Register Izin EDAR PSATPDUK')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add Register Izin EDAR PSATPDUK</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register-izinedar-psatpduk.store') }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    @include('admin.components.notification.error-validation', [
                                        'field' => 'nomor_izinedar_pduk',
                                    ])
                                    <input type="text" name="nomor_izinedar_pduk" class="form-control" id="nomor_izinedar_pduk"
                                        placeholder="contoh:  IZIN-EDAR-001" value="{{ old('nomor_izinedar_pduk') }}">
                                </div>
                            </div>
