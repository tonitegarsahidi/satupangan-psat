...
@section('page-title', 'Detail of Register Izin EDAR PSATPDUK')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Detail of Register Izin EDAR PSATPDUK with id : {{ $data->id }}</h3>
                </div>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="col" class="bg-dark text-white">File Izin EDAR PSATPDUK>
                                    <td>
            ...
            <div class="m-4">
                ...
                <a class="btn btn-primary me-2" href="{{ route('register-izinedar-psatpduk.edit', ['id' => $data->id]) }}"
                    title="update this register izinedar psatpduk">
                    <i class='tf-icons bx bx-pencil me-2'></i>Edit</a>
                <a class="btn btn-danger me-2" href="{{ route('register-izinedar-psatpduk.delete', ['id' => $data->id]) }}"
