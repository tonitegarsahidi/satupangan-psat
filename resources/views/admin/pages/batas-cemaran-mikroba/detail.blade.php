...
@section('page-title', 'Detail Batas Cemaran Mikroba')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Detail Batas Cemaran Mikroba</h5>
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.batas-cemaran-mikroba.edit', $data->id) }}" class="btn btn-warning">
