...
@section('page-title', 'Edit Batas Cemaran Mikroba')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" name="value_min" class="form-control" id="value_min"
                                        placeholder="contoh: 0.1" value="{{ old('value_min', $batasCemaranMikroba->value_min) }}" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" name="value_max" class="form-control" id="value_max"
                                        placeholder="contoh: 0.5" value="{{ old('value_max', $batasCemaranMikroba->value_max) }}" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="satuan" class="form-control" id="satuan"
                                        placeholder="contoh: CFU/g" value="{{ old('satuan', $batasCemaranMikroba->satuan) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="metode" class="form-control" id="metode"
                                        placeholder="contoh: ISO 4833" value="{{ old('metode', $batasCemaranMikroba->metode) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="keterangan" class="form-control" id="keterangan" rows="3"
                                        placeholder="contoh: Batas maksimum untuk mikroba dalam pangan">{{ old('keterangan', $batasCemaranMikroba->keterangan) }}</textarea>
                                </div>
                            </div>
