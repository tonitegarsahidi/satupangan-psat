...
@section('page-title', 'Add New Cemaran Mikroba')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add Cemaran Mikroba</h5>
                        <small class="text-muted float-end">* : must be filled</small>
                    </div>
                    <div class="card-body">

                        <form method="POST" action="{{ route('admin.master-cemaran-mikroba.store') }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @include('admin.components.notification.error-validation', ['field' => 'kode_cemaran_mikroba'])
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    {{-- form validation error --}}
                                    @include('admin.components.notification.error-validation', ['field' => 'nama_cemaran_mikroba'])
