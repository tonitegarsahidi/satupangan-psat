...
@section('page-title', 'Edit Kelompok Pangan')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit Kelompok Pangan</h5>
                        <small class="text-muted float-end">* : must be filled</small>
                    </div>
                    @include('admin.components.notification.error')
                    <div class="card-body">
                        <form action="{{ route('admin.master-kelompok-pangan.update', $kelompokPangan->id) }}"  method="POST">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row mb-3">
                                @php
                                    $oldIsActive = old('is_active', $kelompokPangan->is_active);
                                @endphp
