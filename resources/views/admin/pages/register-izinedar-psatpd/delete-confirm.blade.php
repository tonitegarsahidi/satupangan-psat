...
@section('page-title', 'Confirm Delete Register Izin EDAR PSATPD')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Are you sure want to delete this Register Izin EDAR PSATPD?</h3>
                </div>
            ...
            <div class="m-4">
                ...
                <form action="{{ route('register-izinedar-psatpd.delete', $data->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="col" class="bg-dark text-white">File Izin EDAR PSATPD</th>
                                    <td>
