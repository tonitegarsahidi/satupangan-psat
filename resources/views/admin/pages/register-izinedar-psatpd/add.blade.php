...
@section('page-title', 'Add New Register Izin EDAR PSATPD')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add Register Izin EDAR PSATPD</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register-izinedar-psatpd.store') }}"
