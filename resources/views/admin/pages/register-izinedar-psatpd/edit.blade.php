...
@section('page-title', 'Edit Register Izin EDAR PSATPD')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit Register Izin EDAR PSATPD</h5>
                        <small class="text-muted float-end">* : must be filled</small>
                    </div>
                    @include('admin.components.notification.error')
                    <div class="card-body">
                        <form method="POST" action="{{ route('register-izinedar-psatpd.update', $registerIzinedarPsatpd->id) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf

                            {{-- BUSINESS ID FIELD (Hidden) --}}
                            <input type="hidden" name="business_id" id="business_id" value="{{ $registerIzinedarPsatpd->business_id }}">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Nama Unit Usaha</label>
                                <div class="col-sm-10">
                                    <div class="form-control-plaintext">{{ $registerIzinedarPsatpd->business->nama_usaha }}</div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="status" id="status" class="form-control" required>
                                        ...
                                        <option value="DIAJUKAN" {{ old('status', $registerIzinedarPsatpd->status) == 'DIAJUKAN' ? 'selected' : '' }}>DIAJUKAN</option>
                                        <option value="DISETUJUI" {{ old('status', $registerIzinedarPsatpd->status) == 'DISETUJUI' ? 'selected' : '' }}>DISETUJUI</option>
                                        <option value="DITOLAK" {{ old('status', $registerIzinedarPsatpd->status) == 'DITOLAK' ? 'selected' : '' }}>DITOLAK</option>
                                        <option value="DIPERIKSA" {{ old('status', $registerIzinedarPsatpd->status) == 'DIPERIKSA' ? 'selected' : '' }}>DIPERIKSA</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" name="is_enabled" class="form-check-input" id="is_enabled" value="1" {{ old('is_enabled', $registerIzinedarPsatpd->is_enabled) ? 'checked' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="nomor_sppb" class="form-control" id="nomor_sppb"
                                        placeholder="contoh:  SPPB-001" value="{{ old('nomor_sppb', $registerIzinedarPsatpd->nomor_sppb) }}">
                                </div>
                            </div>

                            {{-- NOMOR IZIN EDAR PL FIELD --}}
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="nomor_izinedar_pd">Nomor Izin EDAR PL</label>
                                <div class="col-sm-10">
                                    @include('admin.components.notification.error-validation', ['field' => 'nomor_izinedar_pd'])
                                    <input type="text" name="nomor_izinedar_pd" class="form-control" id="nomor_izinedar_pd"
                                        placeholder="contoh:  IZIN-EDAR-001" value="{{ old('nomor_izinedar_pd', $registerIzinedarPsatpd->nomor_izinedar_pd) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="nama_unitusaha" class="form-control" id="nama_unitusaha"
                                        placeholder="contoh:  PT. Contoh Jaya" value="{{ old('nama_unitusaha', $registerIzinedarPsatpd->nama_unitusaha) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="alamat_unitusaha" class="form-control" id="alamat_unitusaha"
                                        placeholder="contoh:  Jl. Contoh No. 1" value="{{ old('alamat_unitusaha', $registerIzinedarPsatpd->alamat_unitusaha) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="alamat_unitpenanganan" class="form-control" id="alamat_unitpenanganan"
                                        placeholder="contoh:  Jl. Contoh No. 1" value="{{ old('alamat_unitpenanganan', $registerIzinedarPsatpd->alamat_unitpenanganan) }}">
                                </div>
                            </div>
                            ...
                            @include('components.provinsi-kota', [
                                'provinsis' => $provinsis,
                                'kotas' => $kotas ?? [],
                                'selectedProvinsiId' => old('provinsi_unitusaha', $registerIzinedarPsatpd->provinsi_unitusaha),
                                'selectedKotaId' => old('kota_unitusaha', $registerIzinedarPsatpd->kota_unitusaha),
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="nib_unitusaha" class="form-control" id="nib_unitusaha"
                                        placeholder="contoh:  1234567890" value="{{ old('nib_unitusaha', $registerIzinedarPsatpd->nib_unitusaha) }}">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="jenis_psat" id="jenis_psat" class="form-control">
                                        ...
                                        @foreach($jenispsats as $jenispsat)
                                            <option value="{{ $jenispsat->id }}" {{ old('jenis_psat', $registerIzinedarPsatpd->jenis_psat) == $jenispsat->id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="nama_komoditas" class="form-control" id="nama_komoditas"
                                        placeholder="contoh:  Melon" value="{{ old('nama_komoditas', $registerIzinedarPsatpd->nama_komoditas) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="nama_latin" class="form-control" id="nama_latin"
                                        placeholder="contoh:  Cucumis melo" value="{{ old('nama_latin', $registerIzinedarPsatpd->nama_latin) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="negara_asal" class="form-control" id="negara_asal"
                                        placeholder="contoh:  Indonesia" value="{{ old('negara_asal', $registerIzinedarPsatpd->negara_asal) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="merk_dagang" class="form-control" id="merk_dagang"
                                        placeholder="contoh:  PanganAman" value="{{ old('merk_dagang', $registerIzinedarPsatpd->merk_dagang) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="jenis_kemasan" class="form-control" id="jenis_kemasan"
                                        placeholder="contoh:  Plastik Wrap" value="{{ old('jenis_kemasan', $registerIzinedarPsatpd->jenis_kemasan) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="ukuran_berat" class="form-control" id="ukuran_berat"
                                        placeholder="contoh:  1.5 kg per buah" value="{{ old('ukuran_berat', $registerIzinedarPsatpd->ukuran_berat) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="klaim" class="form-control" id="klaim"
                                        placeholder="contoh:  Organik, Tanpa Pestisida" value="{{ old('klaim', $registerIzinedarPsatpd->klaim) }}">
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    @if($registerIzinedarPsatpd->foto_1)
                                                        <div class="mb-2">
                                                            <a href="{{ $registerIzinedarPsatpd->foto_1 }}" target="_blank">
                                                                <img src="{{ $registerIzinedarPsatpd->foto_1 }}" alt="Foto 1" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                                            </a>
                                                        </div>
                                                    @endif
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    @if($registerIzinedarPsatpd->foto_2)
                                                        <div class="mb-2">
                                                            <a href="{{ $registerIzinedarPsatpd->foto_2 }}" target="_blank">
                                                                <img src="{{ $registerIzinedarPsatpd->foto_2 }}" alt="Foto 2" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                                            </a>
                                                        </div>
                                                    @endif
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    @if($registerIzinedarPsatpd->foto_3)
                                                        <div class="mb-2">
                                                            <a href="{{ $registerIzinedarPsatpd->foto_3 }}" target="_blank">
                                                                <img src="{{ $registerIzinedarPsatpd->foto_3 }}" alt="Foto 3" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                                            </a>
                                                        </div>
                                                    @endif
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    @if($registerIzinedarPsatpd->foto_4)
                                                        <div class="mb-2">
                                                            <a href="{{ $registerIzinedarPsatpd->foto_4 }}" target="_blank">
                                                                <img src="{{ $registerIzinedarPsatpd->foto_4 }}" alt="Foto 4" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                                            </a>
                                                        </div>
                                                    @endif
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    @if($registerIzinedarPsatpd->foto_5)
                                                        <div class="mb-2">
                                                            <a href="{{ $registerIzinedarPsatpd->foto_5 }}" target="_blank">
                                                                <img src="{{ $registerIzinedarPsatpd->foto_5 }}" alt="Foto 5" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                                            </a>
                                                        </div>
                                                    @endif
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    @if($registerIzinedarPsatpd->foto_6)
                                                        <div class="mb-2">
                                                            <a href="{{ $registerIzinedarPsatpd->foto_6 }}" target="_blank">
                                                                <img src="{{ $registerIzinedarPsatpd->foto_6 }}" alt="Foto 6" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                                            </a>
                                                        </div>
                                                    @endif
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if($registerIzinedarPsatpd->file_nib)
                                        <div class="mb-2">
                                            <a href="{{ $registerIzinedarPsatpd->file_nib }}" target="_blank" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if($registerIzinedarPsatpd->file_sppb)
                                        <div class="mb-2">
                                            <a href="{{ $registerIzinedarPsatpd->file_sppb }}" target="_blank" class="btn btn-sm btn-outline-primary">
                            ...
                            {{-- FILE IZIN EDAR PSATPD FIELD --}}
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="file_izinedar_psatpd">File Izin EDAR PSATPD</label>
                                <div class="col-sm-10">
                                    @include('admin.components.notification.error-validation', ['field' => 'file_izinedar_psatpd'])
                                    @if($registerIzinedarPsatpd->file_izinedar_psatpd)
                                        <div class="mb-2">
                                            <a href="{{ $registerIzinedarPsatpd->file_izinedar_psatpd }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                                <i class="bx bx-file-pdf me-1"></i> Lihat File Izin EDAR PSATPD
                                            </a>
                                        </div>
                                    @endif
                                    <input type="file" name="file_izinedar_psatpd" class="form-control" accept=".pdf,.jpeg,.jpg,.doc,.docx,.png">
                                    <small class="text-muted">Format: PDF, JPEG, JPG, DOC, DOCX, PNG, Maks: 2MB. Kosongkan jika tidak ingin mengubah.</small>
                                </div>
                            </div>
                                    ...
                                    <select name="okkp_penangungjawab" id="okkp_penangungjawab" class="form-control"
                                        ...
                                        @foreach ($assignees as $user)
                                            <option value="{{ $user->id }}"
                                                {{ old('okkp_penangungjawab', $registerIzinedarPsatpd->okkp_penangungjawab) == $user->id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="date" name="tanggal_terbit" class="form-control" id="tanggal_terbit"
                                        value="{{ old('tanggal_terbit', $registerIzinedarPsatpd->tanggal_terbit) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="date" name="tanggal_terakhir" class="form-control" id="tanggal_terakhir"
                                        value="{{ old('tanggal_terakhir', $registerIzinedarPsatpd->tanggal_terakhir) }}">
                                </div>
                            </div>
