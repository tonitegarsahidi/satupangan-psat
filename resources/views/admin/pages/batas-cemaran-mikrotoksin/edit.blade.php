        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.batas-cemaran-mikrotoksin.update', $batasCemaranMikrotoksin->id) }}"  method="POST">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row mb-3">
                                @php
                                    $oldIsActive = old('is_active', $batasCemaranMikrotoksin->is_active);
                                @endphp
