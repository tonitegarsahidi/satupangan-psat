...
@section('page-title', 'Edit Batas Cemaran Mikrotoksin')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit Batas Cemaran Mikrotoksin</h5>
                        <small class="text-muted float-end">* : must be filled</small>
                    </div>
                    <div class="card-body">

                        <form method="POST" action="{{ route('admin.batas-cemaran-mikrotoksin.update', $batasCemaranMikrotoksin->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="jenis_psat" id="jenis_psat" class="form-select" required>
                                        ...
                                        @foreach ($jenisPangans as $jenisPangan)
                                            <option value="{{ $jenisPangan->id }}" {{ $batasCemaranMikrotoksin->jenis_psat == $jenisPangan->id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    {{-- form validation error --}}
                                    @include('admin.components.notification.error-validation', ['field' => 'cemaran_mikrotoksin'])
                                    ...
                                    <select name="cemaran_mikrotoksin" id="cemaran_mikrotoksin" class="form-select" required>
                                        ...
                                        @foreach ($cemaranMikrotoksins as $cemaranMikrotoksin)
                                            <option value="{{ $cemaranMikrotoksin->id }}" {{ $batasCemaranMikrotoksin->cemaran_mikrotoksin == $cemaranMikrotoksin->id ? 'selected' : '' }}>
                                                {{ $cemaranMikrotoksin->nama_cemaran_mikrotoksin }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" name="value_min" class="form-control" id="value_min"
                                        placeholder="contoh: 0.01" value="{{ old('value_min', $batasCemaranMikrotoksin->value_min) }}" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" name="value_max" class="form-control" id="value_max"
                                        placeholder="contoh: 0.05" value="{{ old('value_max', $batasCemaranMikrotoksin->value_max) }}" step="any" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="satuan" class="form-control" id="satuan"
                                        placeholder="contoh: µg/kg" value="{{ old('satuan', $batasCemaranMikrotoksin->satuan) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" name="metode" class="form-control" id="metode"
                                        placeholder="contoh: HPLC" value="{{ old('metode', $batasCemaranMikrotoksin->metode) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="keterangan" class="form-control" id="keterangan" rows="3"
                                        placeholder="contoh: Batas maksimum untuk mikrotoksin dalam pangan">{{ old('keterangan', $batasCemaranMikrotoksin->keterangan) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                @php
                                    $oldIsActive = old('is_active', $batasCemaranMikrotoksin->is_active); // Default to current value
                                @endphp
