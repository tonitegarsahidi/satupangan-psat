...
@section('page-title', 'Delete Batas Cemaran Mikrotoksin')
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Delete Batas Cemaran Mikrotoksin</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.batas-cemaran-mikrotoksin.destroy', $data->id) }}">
                            @csrf
                            @method('DELETE')
