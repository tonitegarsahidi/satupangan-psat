...
@section('page-title', 'Confirm Delete Batas Cemaran Mikrotoksin')
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="bd-highlight">
                    <h3 class="card-header">Are you sure want to delete this Batas Cemaran Mikrotoksin?</h3>
                </div>
            ...
            <div class="m-4">
                ...
                <form action="{{ route('admin.batas-cemaran-mikrotoksin.delete', $data->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
