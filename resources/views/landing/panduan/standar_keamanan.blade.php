        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <p class="text-center mb-5">Di halaman ini, Anda dapat menemukan informasi lengkap mengenai standar keamanan dan mutu pangan segar asal tumbuhan yang berlaku di Indonesia.</p>
                    <p class="text-center mb-5">Ini mencakup berbagai regulasi dan pedoman yang harus dipatuhi oleh pelaku usaha untuk memastikan produk yang aman dan berkualitas.</p>

                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">
                                <i class="fas fa-clipboard-list"></i>
                                Regulasi dan Pedoman Utama
                            </h3>
                            <ol class="list-group">
                                <li class="list-group-item">
                                    <i class="fas fa-balance-scale"></i>
                                    **Peraturan Kepala Badan Pangan Nasional:** Mengatur tentang standar keamanan pangan segar.
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-book-open"></i>
                                    **Pedoman Cara Budidaya Pangan Segar yang Baik (Good Agricultural Practices - GAP):** Panduan untuk produksi yang aman.
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-industry"></i>
                                    **Pedoman Cara Penanganan Pangan Segar yang Baik (Good Handling Practices - GHP):** Panduan untuk penanganan pascapanen yang higienis.
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-microscope"></i>
                                    **Batas Maksimum Residu Pestisida (BMR):** Batas aman residu pestisida dalam produk pangan.
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-flask"></i>
                                    **Batas Maksimum Cemaran Logam Berat dan Mikroba:** Batas aman kontaminan lain dalam produk pangan.
                                </li>
                            </ol>
                        </div>
                    </div>
