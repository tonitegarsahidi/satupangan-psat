        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <p class="text-center mb-5">Di halaman ini, Anda dapat menemukan panduan tentang bagaimana cara mengajukan permintaan informasi seputar standar dan prosedur keamanan pangan.</p>
                    <p class="text-center mb-5">Sistem ini juga memfasilitasi pembinaan dan konsultasi antara pelaku usaha, masyarakat, dan petugas OKKP.</p>
                        ...
                        <div class="card-body">
                            ...
                            <ol class="list-group">
                                <li class="list-group-item">
                                    ...
                                    Pengguna membuat akun di <a href="{{ route('register') }}">sini</a>
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-file-alt"></i>
                                    Pengguna mengisi form permintaan informasi
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-reply"></i>
                                    Petugas akan memberikan tanggapan dan informasi yang diminta
                                </li>
                            </ol>
                        </div>
                    </div>
