    ...
    <section class="hero" id="home">
        <div class="container">
            <div class="hero-content">
                <h1><strong>Lapor Keamanan Pangan</strong></h1>
                <p>Informasi mengenai cara melaporkan temuan pelanggaran keamanan pangan.</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">
                                ...
                                Alur Pelaporan Keamanan Pangan
                            </h3>
                            <ol class="list-group">
                                ...
                                <li class="list-group-item">
                                    ...
                                    Pengguna mengisi form laporan pengaduan
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-check-circle"></i>
                                    Petugas akan memberikan tanggapan dari laporan pengaduan tersebut
                                </li>
                            </ol>
                        </div>
                    </div>
