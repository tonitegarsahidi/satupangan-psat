...
<head>
    ...
    <title>Registrasi Izin Produk Pangan - PanganAman</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <p class="text-center mb-5">Di halaman ini, pelaku usaha dapat menemukan panduan tentang bagaimana cara mengajukan izin edar dan penerbitan QR Code untuk produk pangan segar asal tumbuhan.</p>
                    <p class="text-center mb-5">Sistem ini memfasilitasi pengelolaan data usaha dan produk PSAT, serta penerimaan notifikasi surveilan dan konsultasi langsung dengan petugas OKKP.</p>
                        ...
                        <div class="card-body">
                            ...
                            <ol class="list-group">
                                <li class="list-group-item">
                                    ...
                                    User membuat akun pelaku usaha di <a href="{{ route('register-business') }}">Sini</a>
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-building"></i>
                                    Untuk usaha UMKM cukup mengisi data Izin Edar PSAT PDUK
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-industry"></i>
                                    Untuk usaha Non UMKM, mengisi data SPPB dan data Izin Edar PSAT (PL untuk produk impor, PD untuk produk lokal)
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-qrcode"></i>
                                    User mengisi form pengajuan QR Badan Pangan
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-clipboard-check"></i>
                                    Petugas akan mereview, dan memberikan approval/penolakan dari permintaan ini
                                </li>
                                <li class="list-group-item">
                                    <i class="fas fa-print"></i>
                                    Jika disetujui, QR code akan terbit dan dapat disematkan di kemasan Anda
                                </li>
                            </ol>
                        </div>
                    </div>
