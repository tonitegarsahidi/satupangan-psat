...
<body>
    ...
    <div class="container px-4 py-5">
        <div class="row row-cols-1 g-4 pt-4">
            <div class="col">
                <p>Di halaman ini, Anda dapat menemukan informasi dan panduan tentang bagaimana cara mengecek data keamanan pangan segar asal tumbuhan.</p>
                <p>Fitur ini memungkinkan konsumen untuk memindai QR Code pada produk PSAT untuk memastikan legalitas dan keamanannya.</p>
