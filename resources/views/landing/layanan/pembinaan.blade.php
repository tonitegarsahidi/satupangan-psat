...
<head>
    ...
    <title>Pembinaan - PanganAman</title>
...
<body>
    ...
    @include('components.landing.hero', [
        ...
        'subtitle' => 'Artikel dan informasi terkait pembinaan serta konsultasi keamanan pangan.'
    ])
                ...
                <div class="text-center">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4>Belum ada artikel pembinaan</h4>
                            <p class="text-muted">Artikel pembinaan akan segera ditambahkan. Silakan kembali lagi nanti.</p>
                        </div>
                    </div>
                </div>
            @endif
