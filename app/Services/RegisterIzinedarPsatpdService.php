...
class RegisterIzinedarPsatpdService
{
    ...
    /**
     * =============================================
     * Check if certain nomor_izinedar_pd is exists or not
     * YOU CAN ALSO BLACKLIST some nomor_izinedar_pd in this logic
     * =============================================
     */
    public function checkRegisterIzinedarPsatpdExist(string $nomor_izinedar_pd): bool{
        return $this->registerIzinedarPsatpdRepository->isRegisterIzinedarPsatpdExist($nomor_izinedar_pd);
    }
    ...
    public function updateStatus($id, $status, $updatedBy)
    {
        DB::beginTransaction();
        try {
            $registerIzinedarPsatpd = $this->registerIzinedarPsatpdRepository->updateStatus($id, $status);
            $registerIzinedarPsatpd->updated_by = $updatedBy;
            ...
            DB::rollBack();
            Log::error("Failed to update status for RegisterIzinedarPsatpd with id $id: {$exception->getMessage()}");
            return false;
        }
    }
}
