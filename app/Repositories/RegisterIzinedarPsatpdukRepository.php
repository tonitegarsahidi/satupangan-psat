...
class RegisterIzinedarPsatpdukRepository
{
    ...
    public function isRegisterIzinedarPsatpdukExist(String $nomor_izinedar_pl){
        return RegisterIzinedarPsatpduk::where('nomor_izinedar_pl', $nomor_izinedar_pl)->exists();
    }
