...
class PengawasanTindakanLanjutanEditRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'pengawasan_tindakan_id' => 'sometimes|required|exists:pengawasan_tindakan,id',
            'user_id_pic' => 'sometimes|required|exists:users,id',
            'tindak_lanjut' => 'sometimes|required|string|max:255',
