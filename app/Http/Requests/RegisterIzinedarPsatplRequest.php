...
class RegisterIzinedarPsatplRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'file_izinedar_psatpl' => 'nullable|file|mimes:pdf,jpeg,jpg,doc,docx,png',
    ...
    public function messages(): array
    {
        return [
            ...
            'file_izinedar_psatpl.mimes' => 'File Izin EDAR PSATPL harus berformat PDF, JPEG, JPG, DOC, DOCX, atau PNG',
