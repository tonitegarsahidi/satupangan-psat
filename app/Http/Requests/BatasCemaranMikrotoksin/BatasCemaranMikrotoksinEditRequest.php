...
namespace App\Http\Requests\BatasCemaranMikrotoksin;

use Illuminate\Foundation\Http\FormRequest;

class BatasCemaranMikrotoksinEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'cemaran_mikrotoksin' => 'required|exists:master_cemaran_mikrotoxins,id',
    ...
    public function messages()
    {
        return [
            ...
            'cemaran_mikrotoksin.required' => 'Cemaran Mikrotoksin is required.',
            'cemaran_mikrotoksin.exists' => 'Selected Cemaran Mikrotoksin does not exist.',
