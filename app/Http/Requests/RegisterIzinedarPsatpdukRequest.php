...
class RegisterIzinedarPsatpdukRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'nomor_izinedar_pduk' => 'nullable|string|max:50',
            ...
            'kategorilabel' => 'nullable|in:Label Putih,Label Hijau',
            ...
            'file_izinedar_psatpduk' => 'nullable|file|mimes:pdf,jpeg,jpg,doc,docx,png',
    ...
    public function messages(): array
    {
        return [
            ...
            'nomor_izinedar_pduk.max' => 'Nomor Izin EDAR PL maksimal 50 karakter',
            ...
            'kategorilabel.in' => 'Kategori label harus salah satu dari: Label Putih, Label Hijau',
            ...
            'file_izinedar_psatpduk.mimes' => 'File Izin EDAR PSATPDUK harus berformat PDF, JPEG, JPG, DOC, DOCX, atau PNG',
