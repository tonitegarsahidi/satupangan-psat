...
namespace App\Http\Requests\BatasCemaranPestisida;

use Illuminate\Foundation\Http\FormRequest;

class BatasCemaranPestisidaEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'cemaran_pestisida' => 'required|exists:master_cemaran_pestisidas,id',
    ...
    public function messages()
    {
        return [
            ...
            'cemaran_pestisida.required' => 'Cemaran Pestisida is required.',
            'cemaran_pestisida.exists' => 'Selected Cemaran Pestisida does not exist.',
