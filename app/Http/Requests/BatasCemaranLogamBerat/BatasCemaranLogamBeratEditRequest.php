...
namespace App\Http\Requests\BatasCemaranLogamBerat;

use Illuminate\Foundation\Http\FormRequest;

class BatasCemaranLogamBeratEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'cemaran_logam_berat' => 'required|exists:master_cemaran_logam_berats,id',
    ...
    public function messages()
    {
        return [
            ...
            'cemaran_logam_berat.required' => 'Cemaran Logam Berat is required.',
            'cemaran_logam_berat.exists' => 'Selected Cemaran Logam Berat does not exist.',
