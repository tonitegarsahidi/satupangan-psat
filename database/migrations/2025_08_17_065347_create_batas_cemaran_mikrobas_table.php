...
return new class extends Migration
{
    ...
    {
        Schema::create('batas_cemaran_mikrobas', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->foreignUuid('jenis_psat')->references('id')->on('master_jenis_pangan_segars');
            $table->foreignUuid('cemaran_mikroba')->references('id')->on('master_cemaran_mikrobas');
    ...
    {
        Schema::dropIfExists('batas_cemaran_mikrobas');
    }
};
