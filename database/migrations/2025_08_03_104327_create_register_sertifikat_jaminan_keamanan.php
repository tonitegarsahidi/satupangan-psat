...
return new class extends Migration
{
    ...
    {
        Schema::create('register_sertifikat_keamanan_pangan', function (Blueprint $table) {
            ...
            $table->string('nomor_sertifikat_keamanan_pangan', 50)->nullable();
            ...
            $table->string('file_sertifikat_keamanan_pangan', 200)->nullable();
    ...
    {
        Schema::dropIfExists('register_sertifikat_keamanan_pangan');
    }
};
