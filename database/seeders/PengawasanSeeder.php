    ...
    public function run(): void
    {
        ...
        $pengawasanData = [
            [
                ...
                'lokasi_kota_id' => $kotas['Jakarta Pusat'] ?? null,
                'lokasi_provinsi_id' => $provinsis['DKI Jakarta'] ?? null,
            ...
            [
                'id' => Str::uuid(),
                'user_id_initiator' => $users['kantorbali@panganaman.my.id'] ?? null,
                'lokasi_alamat' => 'Jl. Gatot Subroto No. 456, Surabaya',
                'lokasi_kota_id' => $kotas['Surabaya'] ?? null,
                ...
                'is_active' => true,
                'created_by' => $users['kantorbali@panganaman.my.id'] ?? null,
                'updated_by' => $users['kantorbali@panganaman.my.id'] ?? null,
            ],
            [
                'id' => Str::uuid(),
                'user_id_initiator' => $users['kantorjateng@panganaman.my.id'] ?? null,
                'lokasi_alamat' => 'Jl. Raya Bogor Km. 25, Depok',
                'lokasi_kota_id' => $kotas['Depok'] ?? null,
            ...
            [
                'id' => Str::uuid(),
                'user_id_initiator' => $users['kantoraceh@panganaman.my.id'] ?? null,
                'lokasi_alamat' => 'Jl. Ahmad Yani No. 78, Bandung',
                'lokasi_kota_id' => $kotas['Bandung'] ?? null,
                'lokasi_provinsi_id' => $provinsis['Jawa Barat'] ?? null,
                ...
                'is_active' => true,
                'created_by' => $users['kantoraceh@panganaman.my.id'] ?? null,
                'updated_by' => $users['kantoraceh@panganaman.my.id'] ?? null,
            ],
            [
                'id' => Str::uuid(),
                'user_id_initiator' => $users['kantorjatim@panganaman.my.id'] ?? null,
                'lokasi_alamat' => 'Jl. Basuki Rahmat No. 12, Malang',
                'lokasi_kota_id' => $kotas['Malang'] ?? null,
                'lokasi_provinsi_id' => $provinsis['Jawa Timur'] ?? null,
