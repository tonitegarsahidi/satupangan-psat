    ...
    public function run(): void
    {
        ...
        $pengawasanData = [
            ...
            [
                ...
                'lampiran1' => 'files/upload/lampiran1_sample5.pdf',
                'lampiran2' => 'files/upload/lampiran2_sample5.pdf',
                'lampiran3' => 'files/upload/lampiran3_sample5.pdf',
                'lampiran4' => 'files/upload/lampiran4_sample5.pdf',
                'lampiran5' => 'files/upload/lampiran5_sample5.pdf',
                'lampiran6' => 'files/upload/lampiran6_sample5.pdf',
                'status' => 'SELESAI',
                'tindakan_rekomendasikan' => 'Tidak ada tindakan khusus yang diperlukan.',
                'is_active' => true,
                'created_by' => $users['kantorjatim@panganaman.my.id'] ?? null,
