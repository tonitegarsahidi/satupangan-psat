...
class PengawasanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $pengawasanData = [
            [
                'id' => Str::uuid(),
                'user_id_initiator' => $users['admin@panganaman.my.id'] ?? null,
            ...
            [
                'id' => Str::uuid(),
                'user_id_initiator' => $users['supervisor@panganaman.my.id'] ?? null,
            ...
            [
                'id' => Str::uuid(),
                'user_id_initiator' => $users['operator@panganaman.my.id'] ?? null,
            ...
            [
                'id' => Str::uuid(),
                'user_id_initiator' => $users['user@panganaman.my.id'] ?? null,
